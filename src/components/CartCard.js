...
import { closeIc, arrDownIc } from '../styles/icon-variables';
    ...
    return (
      <View style={[styles.card, cardStyles]}>
        ...
        <View style={styles.rightItem}>
          <TouchableOpacity activeOpacity={0.6} onPress={onPressCloseIcon}>
            <Image
              source={require('../../img/icons/ic_close.png')}
              style={{ width: closeIc.width, height: closeIc.height }}
            />
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={0.6} onPress={onSelectQuantity}>
            <View style={styles.quantity}>
              <Text gray normal mediumBold>
                {quantity}
              </Text>
              <Image
